...
public class Embed {
    ...
    public Embed(String inFileName, String secret_message) {
    	this("F5Android", inFileName, null, secret_message);
    }
    
    public Embed(String dump_dir, String inFileName, String secret_message) {
    	this(dump_dir, inFileName, null, secret_message);
    	
    	this.secret_message = secret_message;
    }
    
    public Embed(String dump_dir, String inFileName, String outFileName, String secret_message) {
    	//this.a = a;
    	...
    	if(this.file.exists()) {
    		...
    		try {
    			jpg.Compress(new ByteArrayInputStream(secret_message.getBytes()));
    				/*((EmbedListener) this).onEmbedded(outFile);
    			}*/
