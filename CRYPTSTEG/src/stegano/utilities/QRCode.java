...
public class QRCode {	
	/**
	  * Call this constructor to encode data in a QRCode
	  ...
	  */
	public QRCode(String input, String dir) throws IOException, WriterException {
		genQRCode(input, dir);
	}	
	private void genQRCode(String input, String dir) throws IOException, WriterException {		
